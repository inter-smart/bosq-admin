...
export const aboutCmsSchema = z.object({
  ...
  banner_media_desktop_path: commonValidations.validateFileUpload("Banner Desktop Image"),
  banner_media_mobile_path: commonValidations.validateFileUpload("Banner Mobile Image"),
