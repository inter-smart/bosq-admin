...
export const aboutCmsSchema = z.object({
  ...
  banner_media_desktop_path: commonValidations.optionalFileUploadWithValidation("Banner Desktop Image"),
  banner_media_mobile_path: commonValidations.optionalFileUploadWithValidation("Banner Mobile Image"),
  ...
  journey_one_media_path: commonValidations.optionalFileUploadWithValidation("Journey Image 1"),
  journey_two_media_path: commonValidations.optionalFileUploadWithValidation("Journey Image 2"),
  journey_three_media_path: commonValidations.optionalFileUploadWithValidation("Journey Image 3"),
