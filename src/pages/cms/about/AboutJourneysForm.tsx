...
export default function AboutJourneysForm() {
  ...
  const handleFormSubmit = form.handleSubmit(
    ...
    (errors) => {
      const arabicFields: (keyof AboutJourneysFormData)[] = [
        "title_ar",
      ];

      const firstErrorField = Object.keys(errors)[0] as keyof AboutJourneysFormData;
        ...
        <form onSubmit={handleFormSubmit} className="space-y-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} defaultValue="en" className="w-full">
            ...
            <TabsContent value="ar" className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle>معلومات الرحلة (Journey Information)</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <FormField
                    control={form.control}
