...
export default function ProjectCategoryList() {
  ...
  const { editingSortOrder, handleStatusChange, handleSortOrderChange } =
    useCommonTableActions<ProjectCategory>({
  ...
  const loadCategories = async () => {
    try {
      ...
      const response = await fetchProjectCategoryList(
        currentPage,
        pageSize,
  ...
  const confirmDelete = async () => {
    ...
    try {
      await deleteProjectCategory(deleteItemId);
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem
                onClick={() => navigate(`/project-category/edit/${item.id}`)}
              >
  ...
  return (
    <>
      <DataTable
        ...
        onAdd={() => navigate("/project-category/create")}
