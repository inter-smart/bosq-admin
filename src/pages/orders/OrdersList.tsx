...
import { fetchOrders, Order, updateOrder } from "@/services/orders/ordersApi";
...
export default function OrdersList() {
  ...
  const filters: FilterOption[] = [
    {
      ...
      options: [
        ...
        { label: "Packed", value: "packed", color: "bg-purple-500" },
        { label: "Shipped", value: "shipped", color: "bg-indigo-500" },
        { label: "Delivered", value: "delivered", color: "bg-green-500" },
        { label: "Cancelled", value: "cancelled", color: "bg-red-500" },
        { label: "Returned", value: "returned", color: "bg-gray-500" },
      ],
  ...
  const columns: ColumnDef<Order>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const user = row.original.user;
        return <span className="text-sm">{user?.mobile || "-"}</span>;
      },
    },
    {
    ...
    <>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-[825px]">
          <DialogHeader>
            <DialogTitle>
              Edit Shipping Details - #{selectedOrder?.order_id}
            </DialogTitle>
          </DialogHeader>
