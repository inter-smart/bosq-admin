...
export default function ProductAttributesList() {
  ...
  const { editingSortOrder, handleStatusChange, handleSortOrderChange } =
    useCommonTableActions<ProductAttribute>({
  ...
  const loadAttributes = async () => {
    try {
      ...
      const response = await fetchProductAttributeList(
        currentPage,
        pageSize,
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem
                onClick={() => navigate(`/product-attributes/edit/${item.id}`)}
              >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              product attribute and remove its data from the servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
