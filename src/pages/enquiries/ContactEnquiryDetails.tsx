...
export default function ContactEnquiryDetails() {
  ...
  const loadEnquiry = async (enquiryId: number) => {
    try {
      setLoading(true);
      const response = await fetchContactEnquiryById(enquiryId);
      if (response.success) {
      ...
      toast({
        title: "Error",
        description: "Failed to load contact enquiry details",
        variant: "destructive",
      });
      navigate("/contact-enquiries");
    } finally {
      setLoading(false);
    }
  };
  ...
  if (!enquiry) {
    return (
      <div className="flex flex-col items-center justify-center h-64 space-y-4">
        <p className="text-muted-foreground">Contact enquiry not found</p>
        <Button onClick={() => navigate("/contact-enquiries")}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="outline" size="icon" onClick={() => navigate("/contact-enquiries")}>
            <ArrowLeft className="h-4 w-4" />
          </Button>
          <div>
            <h1 className="text-2xl font-bold">Contact Enquiry Details</h1>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              contact enquiry from {enquiry.name} and remove all associated data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
