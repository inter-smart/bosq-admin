...
import { fetchNewsList, deleteNews, News } from "@/services/news/newsApi";
...
export default function newsList() {
  ...
  const loadNewsItems = async () => {
    try {
      ...
      if (response.success) {
        setNewsItems(response.data.list);
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              news and remove its data from the servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
