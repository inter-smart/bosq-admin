...
const AllProductModelsList = lazy(() => import("./pages/product/AllProductModelsList"));
const AllProductVariantsList = lazy(() => import("./pages/product/AllProductVariantsList"));
const ManageBoughtTogether = lazy(() => import("./pages/product/ManageBoughtTogether"));
const ProductFaqList = lazy(() => import("./pages/product/ProductFaqList"));
const ProductBulkUpload = lazy(() => import("./pages/product/ProductBulkUpload"));
const ProductBulkImageUpload = lazy(() => import("./pages/product/ProductBulkImageUpload"));
const ProductVariantMetaList = lazy(() => import("./pages/product/ProductVariantMetaList"));
const ProductVariantMetaForm = lazy(() => import("./pages/product/ProductVariantMetaForm"));
...
const ProductEnquiriesList = lazy(() => import("./pages/enquiries/ProductEnquiriesList"));
const ProductEnquiryDetails = lazy(() => import("./pages/enquiries/ProductEnquiryDetails"));

// General Enquiries pages
const CustomizationEnquiriesList = lazy(() => import("./pages/enquiries/CustomizationEnquiriesList"));
const CustomizationEnquiryDetails = lazy(() => import("./pages/enquiries/CustomizationEnquiryDetails"));
...
const ProjectEnquiriesList = lazy(() => import("./pages/enquiries/ProjectEnquiriesList"));
const ProjectEnquiryDetails = lazy(() => import("./pages/enquiries/ProjectEnquiryDetails"));
...
// Project images
const ProjectImagesList = lazy(() => import("./pages/cms/projects/ProjectImagesList"));
const ProjectImagesForm = lazy(() => import("./pages/cms/projects/ProjectImagesForm"));
...
const LandingPageForm = lazy(() => import("./pages/landingPage/LandingPageForm"));

const LandingPageList = lazy(() => import("./pages/landingPage/LandingPageList"));

const ProductTypeList = lazy(() => import("./pages/landingPage/ProductTypeList"));
const ProductTypeForm = lazy(() => import("./pages/landingPage/ProductTypeForm"));
